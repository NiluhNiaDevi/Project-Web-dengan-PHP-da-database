<?php
    ...
    if(isset($_POST['bsimpan']))
    {
        ...
        if($_GET['hal'] == "edit")
        {
            ...
            {
                $_SESSION['pesan'] = "Berhasil mengedit data";
      ...
      <div class="row no-gutters mt-5">
          <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                <li class="nav-item">
                  <a class="nav-link active text-white" aria-current="page" href="dashboard.html">Dashboard</a><hr class="bg-secondary">
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="jenis_layanan.php">Daftar layanan</a><hr class="bg-secondary">
                </li>
                <li class="nav-item">
                  <a class="nav-link text-white" href="transaksi.php">Daftar transaksi</a><hr class="bg-secondary">
                </li>
                <li class="nav-item">
